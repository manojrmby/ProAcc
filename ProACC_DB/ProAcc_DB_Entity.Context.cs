...
namespace ProACC_DB
{
    ...
    public partial class ProAccEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> SP_SimplificationReport(string type)
        {
            var typeParameter = type != null ?
                new ObjectParameter("Type", type) :
                new ObjectParameter("Type", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_SimplificationReport", typeParameter);
        }
    }
}
